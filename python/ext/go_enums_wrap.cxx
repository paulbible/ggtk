...
#define SWIGTYPE_p_StringArray swig_types[0]
...
#define SWIGTYPE_p_std__vectorT_size_t_std__allocatorT_size_t_t_t__allocator_type swig_types[11]
...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__go_enums

#else
#  define SWIG_init    init_go_enums

#endif
#define SWIG_name    "_go_enums"
