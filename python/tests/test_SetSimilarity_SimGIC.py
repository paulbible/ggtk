...
class SimGICSetSimilarityTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        ...
        self.set_sim = SimGICSetSimilarity(self.graph, self.ic_map)

class CoreMethodsTests(SimGICSetSimilarityTestCase):
    ####################
    # Basic test
    ####################
    ...
    def test_set_similarity_reflexive_slice_BP(self):
        ...
        """
        g1_terms = self.annos.getGoTermsForGeneBP("A0A0B4J269", self.graph)
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g1_terms[1:]), 0.470364371)
    ...
    def test_set_similarity_BP(self):
        ...
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g2_terms), 0.289207627)
    ...
    def test_set_similarity_reflexive_slice_MF(self):
        ...
        """
        g1_terms = self.annos.getGoTermsForGeneMF("A0A0J9YVX5", self.graph)
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g1_terms[1:]), 0.90439167)
    ...
    def test_set_similarity_MF(self):
        ...
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g2_terms), 0.34648541)
    ...
    def test_set_similarity_reflexive_slice_CC(self):
        ...
        """
        g1_terms = self.annos.getGoTermsForGeneCC("A0AVI4", self.graph)
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g1_terms[1:]), 0.87561012)
    ...
    def test_set_similarity_CC(self):
        ...
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g2_terms), 0.35939116)
