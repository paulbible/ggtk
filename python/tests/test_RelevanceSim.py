...
from ggtk.TermSimilarity import RelevanceSimilarity


class RelevanceSimilarityTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        ...
        self.sim = RelevanceSimilarity(self.graph, self.ic_map)

class CoreMethodsTests(RelevanceSimilarityTestCase):
##########################################################################
...
##########################################################################
    def test_similarity_CC_reflexive_sim(self):
        ...
        GO:0043234 -> protein complex
        """
        self.assertAlmostEqual(self.sim.calculateTermSimilarity("GO:0043234", "GO:0043234"), 0.996683429)
    ...
    def test_similarity_CC(self):
        ...
        """
        self.assertAlmostEqual(self.sim.calculateTermSimilarity("GO:0043234", "GO:0000791"), 0.63161884)
...
##########################################################################
    ...
    def test_normalized_similarity_CC_reflexive_sim(self):
        ...
        GO:0043234 -> protein complex
        """
        self.assertAlmostEqual(self.sim.calculateNormalizedTermSimilarity("GO:0043234", "GO:0043234"), 0.996683429)
    ...
    def test_normalized_similarity_CC(self):
        ...
        GO:0000791 -> euchromatin
        """
        self.assertAlmostEqual(self.sim.calculateNormalizedTermSimilarity("GO:0043234", "GO:0000791"), 0.631618849)
...
##########################################################################
    def test_similarity_BP(self):
        ...
        """
        self.assertAlmostEqual(self.sim.calculateTermSimilarity("GO:0007155", "GO:0044406"), 0.713906685)
    ...
    def test_normalized_similarity_BP(self):
        ...
        GO:0044406 -> adhesion of symbiont to host
        """
        self.assertAlmostEqual(self.sim.calculateNormalizedTermSimilarity("GO:0007155", "GO:0044406"), 0.713906685)
...
##########################################################################
    def test_similarity_MF(self):
        ...
        """
        self.assertAlmostEqual(self.sim.calculateTermSimilarity("GO:0051192", "GO:0050662"), 0.67255545)
    ...
    def test_normalized_similarity_MF(self):
        ...
        GO:0050662 -> coenzyme binding
        """
        self.assertAlmostEqual(self.sim.calculateNormalizedTermSimilarity("GO:0051192", "GO:0050662"), 0.67255545)
