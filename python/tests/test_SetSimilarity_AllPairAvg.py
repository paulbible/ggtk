...
class AllPairsAverageSetSimilarityTestCase(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.term_sim = LinSimilarity(self.graph, self.ic_map)
...
class CoreMethodsTests(AllPairsAverageSetSimilarityTestCase):
    ...
    def test_set_similarity_reflexive_BP(self):
        ...
        """
        g1_terms = self.annos.getGoTermsForGeneBP("A0A0B4J269", self.graph)
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g1_terms), 0.545562458)
    ...
    def test_set_similarity_reflexive_slice_BP(self):
        ...
        """
        g1_terms = self.annos.getGoTermsForGeneBP("A0A0B4J269", self.graph)
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g1_terms[1:]), 0.536042188)
    ...
    def test_set_similarity_BP(self):
        ...
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g2_terms), 0.259268405)
    ...
    def test_set_similarity_reflexive_MF(self):
        ...
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g1_terms), 0.20152102)
    ...
    def test_set_similarity_reflexive_slice_MF(self):
        ...
        """
        g1_terms = self.annos.getGoTermsForGeneMF("A0A0J9YVX5", self.graph)
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g1_terms[1:]), 0.195834099)
    ...
    def test_set_similarity_MF(self):
        ...
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g2_terms), 0.12567561)
    ...
    def test_set_similarity_reflexive_CC(self):
        ...
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g1_terms), 0.460019367)
    ...
    def test_set_similarity_reflexive_slice_CC(self):
        ...
        """
        g1_terms = self.annos.getGoTermsForGeneCC("A0AVI4", self.graph)
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g1_terms[1:]), 0.469187743)
    ...
    def test_set_similarity_CC(self):
        ...
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g2_terms), 0.362365916)
