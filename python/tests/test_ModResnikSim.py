...
from ggtk.TermSimilarity import ModularResnik
from ggtk.TermSimilarity import MICASharedInformation


class ModResnikSimilarityTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        ...
        self.mod_sim = ModularResnik(self.si)

class CoreMethodsTests(ModResnikSimilarityTestCase):
##########################################################################
