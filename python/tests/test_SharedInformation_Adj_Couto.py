...
from ggtk.TermSimilarity import CoutoGraSMAdjustedSharedInformation


class AdjCoutoSharedInformationTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        ...
        self.si = CoutoGraSMAdjustedSharedInformation(self.graph, self.ic_map)

class CoreMethodsTests(AdjCoutoSharedInformationTestCase):
##########################################################################
...
##########################################################################
    def test_shared_information_CC_reflexive_sim(self):
        ...
        GO:0043234 -> protein complex
        """
        self.assertAlmostEqual(self.si.sharedInformation("GO:0043234", "GO:0043234"), 5.70882396)
    ...
    def test_shared_information_CC(self):
        ...
        """
        self.assertAlmostEqual(self.si.sharedInformation("GO:0043234", "GO:0000791"), 2.721148920)
