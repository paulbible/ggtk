...
from ggtk.TermSimilarity import CoutoGraSMSharedInformation


class CoutoSharedInformationTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        ...
        self.si = CoutoGraSMSharedInformation(self.graph, self.ic_map)

class CoreMethodsTests(CoutoSharedInformationTestCase):
##########################################################################
...
##########################################################################
    def test_shared_information_deep_terms_BP(self):
        ...
        """
        self.assertAlmostEqual(self.si.sharedInformation("GO:0000413", "GO:0043966"), 4.14753097)
