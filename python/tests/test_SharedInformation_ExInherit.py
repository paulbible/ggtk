...
from ggtk.TermSimilarity import ExclusivelyInheritedSharedInformation


class ExclusivelyInheritedSharedInformationTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        ...
        self.si = ExclusivelyInheritedSharedInformation(self.graph, self.ic_map)

class CoreMethodsTests(ExclusivelyInheritedSharedInformationTestCase):
##########################################################################
...
##########################################################################
    def test_shared_information_deep_terms_BP(self):
        ...
        """
        self.assertAlmostEqual(self.si.sharedInformation("GO:0000413", "GO:0043966"), 3.538641236)
...
##########################################################################
    def test_shared_information_CC_reflexive_sim(self):
        ...
        GO:0043234 -> protein complex
        """
        self.assertAlmostEqual(self.si.sharedInformation("GO:0043234", "GO:0043234"), 5.7088239618)
    ...
    def test_max_shared_information_CC(self):
        ...
        GO:0043234 -> protein complex
        """
        self.assertAlmostEqual(self.si.maxInformationContent("GO:0043234"), 14.91515631)
...
##########################################################################
    def test_shared_information_BP(self):
        ...
        """
        self.assertAlmostEqual(self.si.sharedInformation("GO:0007155", "GO:0044406"), 3.53888442)
...
##########################################################################
    def test_shared_information_MF(self):
        ...
        """
        self.assertAlmostEqual(self.si.sharedInformation("GO:0051192", "GO:0050662"), 6.50135459)
