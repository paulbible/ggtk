...
class LinSimilairtyTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
...
class CoreMethodsTests(LinSimilairtyTestCase):
##########################################################################
...
##########################################################################
    ...
    def test_similarity_CC(self):
        ...
        """
        self.assertAlmostEqual(self.sim.calculateTermSimilarity("GO:0043234", "GO:0000791"), 0.634365349)
...
##########################################################################
    ...
    def test_normalized_similarity_CC(self):
        ...
        GO:0000791 -> euchromatin
        """
        self.assertAlmostEqual(self.sim.calculateNormalizedTermSimilarity("GO:0043234", "GO:0000791"), 0.634365349)
...
##########################################################################
    def test_similarity_BP(self):
        ...
        """
        self.assertAlmostEqual(self.sim.calculateTermSimilarity("GO:0007155", "GO:0044406"), 0.714509483)
    ...
    def test_normalized_similarity_BP(self):
        ...
        GO:0044406 -> adhesion of symbiont to host
        """
        self.assertAlmostEqual(self.sim.calculateNormalizedTermSimilarity("GO:0007155", "GO:0044406"), 0.714509483)
...
##########################################################################
    def test_similarity_MF(self):
        ...
        """
        self.assertAlmostEqual(self.sim.calculateTermSimilarity("GO:0051192", "GO:0050662"), 0.67356674)
    ...
    def test_normalized_similarity_MF(self):
        ...
        GO:0050662 -> coenzyme binding
        """
        self.assertAlmostEqual(self.sim.calculateNormalizedTermSimilarity("GO:0051192", "GO:0050662"), 0.67356674)
