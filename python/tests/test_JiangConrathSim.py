...
##########################################################################
    ...
    def test_similarity_CC(self):
        ...
        """
        self.assertAlmostEqual(self.sim.calculateTermSimilarity("GO:0043234", "GO:0000791"), 0.789688805)
    ...
    def test_similarity_CC_1_good_1_root(self):
        ...
        """
        self.assertAlmostEqual(self.sim.calculateTermSimilarity("GO:0043234", "GO:0005575"), 0.808623394)
...
##########################################################################
    ...
    def test_normalized_similarity_CC(self):
        ...
        GO:0000791 -> euchromatin
        """
        self.assertAlmostEqual(self.sim.calculateNormalizedTermSimilarity("GO:0043234", "GO:0000791"), 0.789688805)
    ...
    def test_normalized_similarity_CC_1_good_1_root(self):
        ...
        GO:0043234 -> protein complex
        """
        self.assertAlmostEqual(self.sim.calculateNormalizedTermSimilarity("GO:0043234", "GO:0005575"), 0.808623394)
...
##########################################################################
    def test_similarity_BP(self):
        ...
        """
        self.assertAlmostEqual(self.sim.calculateTermSimilarity("GO:0007155", "GO:0044406"), 0.814125375)
    ...
    def test_normalized_similarity_BP(self):
        ...
        GO:0044406 -> adhesion of symbiont to host
        """
        self.assertAlmostEqual(self.sim.calculateNormalizedTermSimilarity("GO:0007155", "GO:0044406"), 0.81412537)
...
##########################################################################
    def test_similarity_MF(self):
        ...
        """
        self.assertAlmostEqual(self.sim.calculateTermSimilarity("GO:0051192", "GO:0050662"), 0.74620920)
    ...
    def test_normalized_similarity_MF(self):
        ...
        GO:0050662 -> coenzyme binding
        """
        self.assertAlmostEqual(self.sim.calculateNormalizedTermSimilarity("GO:0051192", "GO:0050662"), 0.74620920)
