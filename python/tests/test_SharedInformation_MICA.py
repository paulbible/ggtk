...
class MICASharedInformationTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
...
class CoreMethodsTests(MICASharedInformationTestCase):
##########################################################################
...
##########################################################################
    def test_shared_information_deep_terms_BP(self):
        ...
        """
        self.assertAlmostEqual(self.si.sharedInformation("GO:0000413", "GO:0043966"), 7.919523306)
...
##########################################################################
    ...
    def test_shared_information_CC(self):
        ...
        """
        self.assertAlmostEqual(self.si.sharedInformation("GO:0043234", "GO:0000791"), 5.44229784)
...
##########################################################################
    def test_shared_information_BP(self):
        ...
        """
        self.assertAlmostEqual(self.si.sharedInformation("GO:0007155", "GO:0044406"), 7.077768859)
