...
from ggtk.TermSimilarity import FrontierSharedInformation


class FrontierSharedInformationTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        ...
        self.si = FrontierSharedInformation(self.graph, self.ic_map)

class CoreMethodsTests(FrontierSharedInformationTestCase):
##########################################################################
...
##########################################################################
    def test_shared_information_CC_reflexive_sim(self):
        ...
        GO:0043234 -> protein complex
        """
        self.assertAlmostEqual(self.si.sharedInformation("GO:0043234", "GO:0043234"), 5.708823961)
