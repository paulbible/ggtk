...
class BestMatchAverageSetSimilarityTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        ...
        self.set_sim = BestMatchAverageSetSimilarity(self.term_sim)


class CoreMethodsTests(BestMatchAverageSetSimilarityTestCase):
    ####################
    # Basic test
    ####################
    ...
    def test_set_similarity_reflexive_slice_BP(self):
        ...
        """
        g1_terms = self.annos.getGoTermsForGeneBP("A0A0B4J269", self.graph)
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g1_terms[1:]), 0.950444664)
    ...
    def test_set_similarity_BP(self):
        ...
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g2_terms), 0.820939947)
    ...
    def test_set_similarity_reflexive_slice_MF(self):
        ...
        """
        g1_terms = self.annos.getGoTermsForGeneMF("A0A0J9YVX5", self.graph)
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g1_terms[1:]), 0.9659733253)
    ...
    def test_set_similarity_MF(self):
        ...
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g2_terms), 0.794793986)
    ...
    def test_set_similarity_reflexive_slice_CC(self):
        ...
        """
        g1_terms = self.annos.getGoTermsForGeneCC("A0AVI4", self.graph)
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g1_terms[1:]), 0.985022648)
    ...
    def test_set_similarity_CC(self):
        ...
        self.assertAlmostEqual(self.set_sim.calculateSimilarity(g1_terms,g2_terms),  0.919228551)
