...
GGTK is a set of modular tools for working with the Gene Ontology Graph. These pages provide documentation for the Python interface for GGTK. For C++ documentaiton see the Doygen files located in GGTK_HOME/docs.
...
After Python has built and installed the package you may optionally run the tests::
