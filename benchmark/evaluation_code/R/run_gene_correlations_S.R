...
spearman.boot.mat <- bootCatMatrix(spearman.files, bootstrap_cor_s)
...
write.table(spearman.dtable, file="results/spearman_gene_exp_table.csv", quote=FALSE, sep=",")
write.table(spearman.boot.mat, file="results/spearman_gene_exp_bootstrap.txt")
