...
pearson.boot.mat <- bootCatMatrix(pearson.files, bootstrap_abs_score_cor_s)
...
write.table(pearson.dtable, file="results/pearson_abs_gene_exp_table.csv", quote=FALSE, sep=",")
write.table(pearson.boot.mat, file="results/pearson_abs_gene_exp_bootstrap.txt")
